...
public class CallingActivity extends AppCompatActivity {
    ...
    private ImageView cancelBtn, make_call;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameContact=findViewById(R.id.user_calling);
                ...
                userRef.child(senderUserId).child("Ringing")
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task)
                            {
                                ...
                                {
                                    Intent intent=new Intent(CallingActivity.this,VideoCall.class);
    ...
    private void getAndSendUserProfileInfo()
    {
